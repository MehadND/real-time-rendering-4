...
//	cubeObjFromFile.setTranslate(0, 0, 0);
//
...
//
//	cubeObjFromFile.setPrimitiveMode(GL_TRIANGLE_STRIP);
//	cubeObjFromFile.createVBO(objVertz, 24);
//	cubeObjFromFile.setShader(&shaderA);
//}
//
